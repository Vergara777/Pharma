                ...
                <div style="flex: 1; overflow-y: auto; padding: 1.5rem;">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(empty($cart)): ?>
                        <div style="text-align: center; padding: 3rem 0;">
                            ...
                            <a 
                                href="<?php echo e(route('filament.admin.resources.products.index')); ?>"
                    ...
                    <?php else: ?>
                                ...
                                <div style="display: flex; gap: 1rem; padding: 1rem; background-color: #f9fafb; border-radius: 0.75rem; border: 1px solid #e5e7eb;" class="dark:bg-gray-800 dark:border-gray-700">
                                    ...
                                    <div style="flex-shrink: 0;">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($item['image'])): ?>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(str_starts_with($item['image'], 'http')): ?>
                                                <img src="<?php echo e($item['image']); ?>" alt="<?php echo e($item['name']); ?>" style="width: 5rem; height: 5rem; object-fit: cover; border-radius: 0.5rem;">
                                            <?php else: ?>
                                                <img src="<?php echo e(Storage::disk('local')->url($item['image'])); ?>" alt="<?php echo e($item['name']); ?>" style="width: 5rem; height: 5rem; object-fit: cover; border-radius: 0.5rem;">
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        <?php else: ?>
                                    ...
                                    <div style="flex: 1; min-width: 0;">
                                        ...
                                        <p style="font-size: 0.875rem; color: #6b7280;" class="dark:text-gray-400">
                                            $<?php echo e(number_format($item['price'], 0, ',', '.')); ?> c/u
                                        </p>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($item['stock_available'])): ?>
                                            <p style="font-size: 0.75rem; color: #9ca3af; margin-top: 0.25rem;" class="dark:text-gray-500">
                                                Stock disponible: <?php echo e($item['stock_available']); ?>
                                    ...
                                    <div style="display: flex; flex-direction: column; align-items: flex-end; justify-content: space-between;">
                                        ...
                                        <div style="display: flex; align-items: center; gap: 0.5rem; margin-top: 0.5rem;">
                                            <button 
                                                wire:click="decreaseQuantity(<?php echo e($item['product_id']); ?>)"
                                            ...
                                            <button 
                                                wire:click="increaseQuantity(<?php echo e($item['product_id']); ?>)"
                        ...
                        <!-- Form de pago -->
                        <form 
                            action="<?php echo e(route('cart.finalize')); ?>" 
                            method="POST" 
                            style="display: flex; flex-direction: column; gap: 1rem;"
                            x-data="{
                                submitForm(event) {
                                    // Copiar valores de Livewire a los campos hidden antes de enviar
                                    event.target.querySelector('[name=amount_received]').value = window.Livewire.find('<?php echo e($_instance->getId()); ?>').amountReceived;
                                    event.target.querySelector('[name=payment_reference]').value = window.Livewire.find('<?php echo e($_instance->getId()); ?>').paymentReference;
                                    event.target.querySelector('[name=customer_name]').value = window.Livewire.find('<?php echo e($_instance->getId()); ?>').customerName;
                                    event.target.querySelector('[name=customer_phone]').value = window.Livewire.find('<?php echo e($_instance->getId()); ?>').customerPhone;
                                    event.target.querySelector('[name=customer_email]').value = window.Livewire.find('<?php echo e($_instance->getId()); ?>').customerEmail;
                                    event.target.querySelector('[name=customer_document]').value = window.Livewire.find('<?php echo e($_instance->getId()); ?>').customerDocument;
                                    event.target.querySelector('[name=customer_address]').value = window.Livewire.find('<?php echo e($_instance->getId()); ?>').customerAddress;
                                    event.target.querySelector('[name=generate_invoice]').value = window.Livewire.find('<?php echo e($_instance->getId()); ?>').generateInvoice ? '1' : '0';
                                    event.target.querySelector('[name=invoice_type]').value = window.Livewire.find('<?php echo e($_instance->getId()); ?>').invoiceType;
                                }
                            }"
                            @submit="submitForm"
                        >
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectedPaymentMethod === 'Efectivo'): ?>
                                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem; padding: 1rem; background-color: #fef3c7; border-radius: 0.5rem; border: 2px solid #fbbf24;" class="dark:bg-yellow-900 dark:border-yellow-700">
                                    <div>
                                        ...
                                        <input 
                                            type="text" 
                                            x-data="{ 
                                                value: <?php if ((object) ('amountReceived') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('amountReceived'->value()); ?>')<?php echo e('amountReceived'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('amountReceived'); ?>')<?php endif; ?>.live,
                                                formatted: '',
                                                format() {
                                    ...
                                    <div>
                                        ...
                                        <div style="width: 100%; padding: 0.75rem; font-size: 1.125rem; font-weight: 700; border: 2px solid #fbbf24; border-radius: 0.5rem; background-color: white; color: <?php echo e($change >= 0 ? '#059669' : '#dc2626'); ?>;" class="dark:bg-gray-800">
                                            $<?php echo e(number_format($change, 0, ',', '.')); ?>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectedPaymentMethod && $selectedPaymentMethod !== 'Efectivo'): ?>
                            ...
                            <div style="padding: 1rem; background-color: white; border-radius: 0.5rem; border: 1px solid #e5e7eb;" class="dark:bg-gray-800 dark:border-gray-700">
                                ...
                                <div style="display: flex; flex-direction: column; gap: 0.5rem;">
                                    <label style="display: flex; align-items: center; padding: 0.75rem; border: 2px solid; border-radius: 0.5rem; cursor: pointer; transition: all 0.15s; border-color: <?php echo e($invoiceType === 'none' ? '#f59e0b' : '#e5e7eb'); ?>; background-color: <?php echo e($invoiceType === 'none' ? '#fef3c7' : 'transparent'); ?>;" class="<?php echo e($invoiceType === 'none' ? '' : 'dark:border-gray-700 hover:border-gray-300'); ?>">
                                        <input 
                                            type="radio" 
                                    ...
                                    <label style="display: flex; align-items: center; padding: 0.75rem; border: 2px solid; border-radius: 0.5rem; cursor: pointer; transition: all 0.15s; border-color: <?php echo e($invoiceType === 'without_data' ? '#f59e0b' : '#e5e7eb'); ?>; background-color: <?php echo e($invoiceType === 'without_data' ? '#fef3c7' : 'transparent'); ?>;" class="<?php echo e($invoiceType === 'without_data' ? '' : 'dark:border-gray-700 hover:border-gray-300'); ?>">
                                        <input 
                                            type="radio" 
                                            wire:model.live="invoiceType" 
                                            value="without_data"
                                    ...
                                    <label style="display: flex; align-items: center; padding: 0.75rem; border: 2px solid; border-radius: 0.5rem; cursor: pointer; transition: all 0.15s; border-color: <?php echo e($invoiceType === 'with_data' ? '#f59e0b' : '#e5e7eb'); ?>; background-color: <?php echo e($invoiceType === 'with_data' ? '#fef3c7' : 'transparent'); ?>;" class="<?php echo e($invoiceType === 'with_data' ? '' : 'dark:border-gray-700 hover:border-gray-300'); ?>">
                                        <input 
                                            type="radio" 
                                            wire:model.live="invoiceType" 
                                            value="with_data"
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($invoiceType === 'with_data'): ?>
                            ...
                            <div style="display: flex; gap: 0.75rem; padding-top: 0.5rem;">
                                ...
                                <button 
                                    ...
                                    class="hover:bg-amber-600"
                                    <?php if($selectedPaymentMethod === 'Efectivo' && $amountReceived < $total): ?> disabled style="opacity: 0.5; cursor: not-allowed;" <?php endif; ?>
                                >
                                    Finalizar Venta
                                </button>
                            </div>
...
<?php /**PATH C:\Pharma\resources\views/livewire/cart-modal.blade.php ENDPATH**/ ?>