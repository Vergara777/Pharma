                ...
                <div style="flex: 1; overflow-y: auto; padding: 1.5rem;">
                    ...
                    <?php else: ?>
                        ...
                        >
                            ...
                            <div style="padding: 1rem; background-color: #f9fafb; border-radius: 0.5rem; border: 1px solid #e5e7eb;" class="dark:bg-gray-800 dark:border-gray-700">
                                <div style="display: flex; align-items: center; justify-content: space-between;">
                                    ...
                                    <button 
                                        ...
                                        style="position: relative; display: inline-flex; height: 1.5rem; width: 2.75rem; align-items: center; border-radius: 9999px; transition: background-color 0.2s; outline: none; background-color: <?php echo e($captureCustomerData ? '#f59e0b' : '#d1d5db'); ?>;"
                                        class="<?php echo e($captureCustomerData ? '' : 'dark:bg-gray-700'); ?>"
                                    >
                                        <span 
                                            style="display: inline-block; height: 1rem; width: 1rem; border-radius: 9999px; background-color: white; transition: transform 0.2s; transform: translateX(<?php echo e($captureCustomerData ? '1.5rem' : '0.25rem'); ?>);"
                                        ></span>
                                    </button>
                                </div>
                            </div>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($captureCustomerData): ?>
                            ...
                            <div style="padding: 1rem; background-color: #fef3c7; border-radius: 0.5rem; border: 1px solid #fbbf24;" class="dark:bg-yellow-900 dark:border-yellow-700">
                                <div style="display: flex; align-items: center; justify-content: space-between;">
                                    ...
                                    <button 
                                        ...
                                        style="position: relative; display: inline-flex; height: 1.5rem; width: 2.75rem; align-items: center; border-radius: 9999px; transition: background-color 0.2s; outline: none; background-color: <?php echo e($generateInvoice ? '#f59e0b' : '#d1d5db'); ?>;"
                                        class="<?php echo e($generateInvoice ? '' : 'dark:bg-gray-700'); ?>"
                                    >
                                        <span 
                                            style="display: inline-block; height: 1rem; width: 1rem; border-radius: 9999px; background-color: white; transition: transform 0.2s; transform: translateX(<?php echo e($generateInvoice ? '1.5rem' : '0.25rem'); ?>);"
                                        ></span>
                                    </button>
                                </div>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($generateInvoice && !$captureCustomerData): ?>
