                ...
                <div>
                    <h2 class="fi-modal-heading">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($unreadNotificationsCount): ?>
                            <span
                                <?php echo e((new ComponentAttributeBag)->color(BadgeComponent::class, 'danger')->class([
                                        'fi-badge fi-size-xs',
                                    ])); ?>
...
<?php /**PATH /home/astro/Documentos/Pharma/resources/views/vendor/filament-notifications/database-notifications.blade.php ENDPATH**/ ?>