...
<?php endif; ?>
                ...
                >
                    <span class="block font-medium"><?php echo e(filament()->getUserName($user)); ?></span>
                    <span class="block text-xs text-gray-500 dark:text-gray-400"><?php echo e($user->role_label); ?></span>
                </span>
...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
        ...
        <div style="display: flex; align-items: center; gap: 12px; padding: 12px 4px;">
            <?php if (isset($component)) { $__componentOriginalceea4679a368984135244eacf4aafeca = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalceea4679a368984135244eacf4aafeca = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament-panels::components.avatar.user','data' => ['user' => $user,'size' => 'lg']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('filament-panels::avatar.user'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php endif; ?>
            <div style="display: flex; flex-direction: column; min-width: 0; flex: 1;">
                <span style="font-weight: 600; font-size: 0.875rem; display: block; margin-bottom: 4px;" class="text-gray-900 dark:text-white"><?php echo e(filament()->getUserName($user)); ?></span>
                <span style="font-size: 0.75rem; display: block;" class="text-gray-500 dark:text-gray-400"><?php echo e($user->role_label); ?></span>
            </div>
        </div>
     <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
            ...
            <div class="flex flex-col">
                <span class="font-medium"><?php echo e($item->getLabel()); ?></span>
                <span class="text-xs text-gray-500 dark:text-gray-400"><?php echo e($user->role_label); ?></span>
            </div>
         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal7a83b62094aac4ed8d85f403cf23f250)): ?>
...
<?php /**PATH C:\Pharma\resources\views/vendor/filament-panels/components/user-menu.blade.php ENDPATH**/ ?>